          ...
          >
            ...
            <motion.div variants={textVariants} className="min-h-[160px] sm:min-h-[140px] md:min-h-[180px] lg:min-h-[220px] mb-4">
              <AnimatePresence mode="wait">
                ...
                >
                  <h1 className="text-4xl md:text-5xl lg:text-[3.7rem] xl:text-[4.15rem] font-semibold tracking-editorial leading-[1.02] text-brand-ink mb-6 text-balance max-w-[12ch]">
                    {current.headline}
                  </h1>
                  <p className="text-lg md:text-xl text-brand-muted tracking-tight max-w-md leading-relaxed">
                    {current.copy}
                  </p>
                </motion.div>
              </AnimatePresence>
            ...
            <motion.div variants={textVariants}>
              <p className="mt-8 text-[10px] uppercase tracking-widest font-medium text-brand-muted">
                Professional previews with identity-preserving editing.
              </p>
            </motion.div>
          </motion.div>
