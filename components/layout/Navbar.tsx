      ...
      <Container>
        <div className="flex h-16 items-center justify-between gap-4">
          <Link
            href="/"
            onClick={closeMenu}
            className="flex flex-col shrink-0 transition-opacity group hover:opacity-70"
          >
            <span className="text-base font-semibold tracking-tight text-brand-ink">
              Draft My Hair
            </span>

            <span className="hidden text-[10px] uppercase tracking-widest text-brand-muted sm:block">
              Same Face. New Hair.
            </span>
          </Link>
