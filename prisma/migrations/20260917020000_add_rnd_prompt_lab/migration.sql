-- R&D Prompt Lab M1 schema.
-- Intentionally contains only R&D tables; no production User/Generation/Payment/Wallet relations.
...
CREATE TABLE "RnDTarget" (
    ...
    "targetType" "RnDTargetType" NOT NULL,
...
CREATE TABLE "RnDJob" (
    ...
    "promptVersionNumber" INTEGER NOT NULL DEFAULT 1,
...
CREATE INDEX "RnDCampaign_createdByUserId_idx" ON "RnDCampaign"("createdByUserId");
CREATE INDEX "RnDCampaign_createdAt_idx" ON "RnDCampaign"("createdAt");
CREATE INDEX "RnDAsset_kind_idx" ON "RnDAsset"("kind");
CREATE INDEX "RnDAsset_createdAt_idx" ON "RnDAsset"("createdAt");
...
CREATE INDEX "RnDJob_targetId_status_idx" ON "RnDJob"("targetId", "status");
...
ALTER TABLE "RnDAttempt" ADD CONSTRAINT "RnDAttempt_artifactId_fkey" FOREIGN KEY ("artifactId") REFERENCES "RnDAsset"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
