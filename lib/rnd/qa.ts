...
const BASE_RULES = [
  ...
  "Identity preservation is a hard gate. Compare SOURCE and GENERATED for facial identity, facial features, skin texture/tone, expression, jawline, ears, neck, head/skull geometry, pose, head tilt/rotation, framing, zoom/crop, perspective, lighting, exposure, background, camera grain, and photographic consistency. Do not allow a good hairstyle score to compensate for identity or photographic regression.",
  ...
  "Hair-only compliance: PASS only when the requested transformation is cleanly localized to hair/beard/color and there is no visible transformation spill into the locked face, skin, ears, neck, clothing, background, or other non-target regions.",
  "Lighting consistency: compare GENERATED against SOURCE for lighting, exposure, color balance, and photographic consistency. Score whether the original photographic conditions remain materially unchanged, independent of whether the hairstyle itself is attractive.",
  "Transformation-only compliance remains a separate gate for the requested change; identity and photographic preservation are independently scored and gated.",
  ...
  "The overall score must reflect the weakest applicable hard/quality dimension: identity, hairstyle/beard/color/buzz-bald as applicable, rootIntegration, and lightingConsistency. Do not average away a weak identity, transformation, integration, or photographic-preservation result.",
  ...
  "If identity, hairOnly, lightingConsistency, transformationOnly, artifacts, transformation gate, rootIntegration, or any applicable transformation score is below production threshold, verdict must be REGENERATE.",
...
const VERIFIER_PROMPT = [
  ...
  "SOURCE is the original photograph. GENERATED is the transformed result.",
  "Inspect the requested transformation and the locked photographic baseline. A visible material identity, non-hair, or lighting regression is a valid blocking defect.",
  "Try to disprove production readiness. Actively search for identity drift, non-hair edits, lighting/background changes, wrong haircut structure, wrong length or silhouette, incorrect weight distribution, styling mismatch, beard errors, color errors, weak root/scalp integration, transformation spill, wig-like edges, painted-on hair, malformed strands, duplicate structures, or other generation defects.",
